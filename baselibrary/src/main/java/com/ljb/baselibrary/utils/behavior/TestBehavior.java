package com.ljb.baselibrary.utils.behavior;
...
public class TestBehavior extends CoordinatorLayout.Behavior {
     ...
     * 这个方法有个重要的参数nestedScrollAxes，表明处理的滑动的方
     *
     ...
     *                        ViewCompat#SCROLL_AXIS_VERTICAL， ViewCompat#SCROLL_AXIS_VERTICAL}
     * @return
     */
    @Override
     ...
     */
    @Override
    public void onNestedScrollAccepted(CoordinatorLayout coordinatorLayout, View child, View directTargetChild, View
            target, int nestedScrollAxes) {
        super.onNestedScrollAccepted(coordinatorLayout, child, directTargetChild, target, nestedScrollAxes);
    }

    /**
     * 户松开手指并且会发生惯性动作之前调用，参数提供了速度信息，可以根据这些速度信息
